...
const unsigned int CteCastillo::ANCHO_CASTILLO = 4;//5;
...
const unsigned int CteCastillo::CANT_LARILLOS_CASTILLO = (ANCHO_CASTILLO* 2 + PROFUNDIDAD_CASTILLO * 2) * ALTURA_CASTILLO;
